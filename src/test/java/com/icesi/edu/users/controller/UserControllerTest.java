...
public class UserControllerTest {
    ...
    public void testController() {
        User user = new User(UUID.randomUUID(), "davidmontano1113@icesi.edu.co", "+573222050551", "David", "Montano", "Pa$$w0rd");
    ...
    public void testControllerEmailDomainNotValid() {
        ...
        assertThrows(RuntimeException.class, () -> userController.createUser(userMapper.fromDTO(userDTO)));
    ...
    public void testControllerEmailNull() {
        User user = new User(UUID.randomUUID(), null, "+573222050551", "David", "Montano", "Pa$$w0rd");
        when(userService.createUser(any())).thenReturn(user);
        userController.createUser(user);
        verify(userService, times(1)).createUser(any());
    }
    ...
    public void testControllerPhoneNumberNull() {
        User user = new User(UUID.randomUUID(), "davidmontano1113@icesi.edu.co", null, "David", "Montano", "Pa$$w0rd");
        when(userService.createUser(any())).thenReturn(user);
        userController.createUser(user);
        verify(userService, times(1)).createUser(any());
    }
