...
public class UsersDemoIntegrationTest {
    ...
    public void createUserSuccessfully() {
        ...
        MvcResult res = mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andReturn();
        UserDTO userDTO = objectMapper.readValue(res.getResponse().getContentAsString(), UserDTO.class);
        assertThat(userDTO, hasProperty("firstName", is("Juan")));
    }
