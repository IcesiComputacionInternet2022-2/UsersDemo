    ...
    protected void doFilterInternal(
        ...
        try {
            if (containsToken(request)) {
                ...
                createUnauthorizedFilter(new UserDemoException(HttpStatus.UNAUTHORIZED, new UserDemoError(ErrorConstants.CODE_UD_10, ErrorConstants.CODE_UD_10.getMessage())), response);
            }
